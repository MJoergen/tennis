...
entity mega65r6 is
  ...
  port (
    ...
    core_btn_up_o           : out   std_logic;
    core_btn_down_o         : out   std_logic;
    core_btn_left_o         : out   std_logic;
    core_btn_right_o        : out   std_logic;
...
begin
  ...
  mega65kbd_to_matrix_inst : entity work.mega65kbd_to_matrix
    ...
    port map (
      ...
      restore_n_o         => open,
      capslock_n_o        => open,
      leftkey_o           => core_btn_left_o,
      upkey_o             => core_btn_up_o
    ); -- mega65kbd_to_matrix_inst : entity work.mega65kbd_to_matrix

  core_btn_down_o  <= core_btn_left_o;
  core_btn_right_o <= core_btn_up_o;
  ...
  uart_xadc_inst : entity work.uart_xadc
    port map (
      clk_i      => vga_clk,
      rst_i      => vga_rst,
